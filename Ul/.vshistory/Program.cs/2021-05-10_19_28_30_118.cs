    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            private static void UserTest()
            {
                ...
                userManager.Add(new Users { FirstName = "Begüm", LastName = "Muşdal", Email = "begum@hotmail.com", Password = "123456" });
                userManager.Add(new Users { FirstName = "Nisa", LastName = "Has", Email = "nisa@hotmail.com", Password = "222222" });
                userManager.Add(new Users { FirstName = "Gizem", LastName = "Baygın", Email = "gizem@hotmail.com", Password = "333333" });
            }
